...
const objectivesFormSchema = z.object({
  objective1Name: z.string().min(2, { message: "Objective name must be at least 2 characters." }),
  objective1Description: z.string().min(10, { message: "Description must be at least 10 characters." }),
...
export default function EditMissionPage({ missionId }) {
  const { language } = useLanguage()
  const router = useRouter()
  const [activeTab, setActiveTab] = useState("details")
  const [animateCards, setAnimateCards] = useState(false)

  // In a real app, you would fetch the mission data based on the ID
  const missionData = {
    id: missionId,
    name: "Trading Streak",
    description:
      "Complete trades for 5 consecutive days to demonstrate consistency and commitment to your trading strategy.",
    difficulty: "medium",
    category: "trading",
    objective1Name: "Daily Trade",
    objective1Description: "Complete at least one trade each day",
    objective1Type: "streak",
    objective1Target: "5",
    xpPoints: "500",
    bonusAmount: "25",
    unlockFeature: false,
  ...
  const objectivesForm = useForm<z.infer<typeof objectivesFormSchema>>({
    ...
    defaultValues: {
      objective1Name: missionData?.objective1Name || "",
      objective1Description: missionData?.objective1Description || "",
      objective1Type: missionData?.objective1Type || "",
      objective1Target: missionData?.objective1Target || "",
    },
  })
  ...
  const rewardsForm = useForm<z.infer<typeof rewardsFormSchema>>({
    ...
    defaultValues: {
      xpPoints: missionData?.xpPoints || "",
      bonusAmount: missionData?.bonusAmount || "",
      unlockFeature: missionData?.unlockFeature || "",
      featureToUnlock: missionData?.featureToUnlock || "",
      badge: missionData?.badge || "",
    },
  })
  ...
  const settingsForm = useForm<z.infer<typeof settingsFormSchema>>({
    ...
    defaultValues: {
      ...
      prerequisite: missionData?.prerequisite || "",
      notifyUsers: missionData?.notifyUsers || "",
    },
  })
  ...
  const getFormDescription = (tab: string) => {
    switch (tab) {
      case "details":
        return language === "fr"
          ? "Mettez à jour les détails de base de cette mission"
          : "Update the basic details for this mission"
      case "objectives":
        return language === "fr"
          ? "Modifiez ce que les utilisateurs doivent faire pour compléter la mission"
          : "Modify what users need to do to complete the mission"
      case "rewards":
        return language === "fr"
          ? "Ajustez ce que les utilisateurs recevront après avoir complété la mission"
          : "Adjust what users will receive upon mission completion"
      case "settings":
        return language === "fr"
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">
              {language === "fr" ? "Modifier la Mission" : "Edit Mission"}
            </h1>
            <motion.div
          ...
          <p className="text-muted-foreground">
            {language === "fr"
              ? "Modifiez une mission existante avec des objectifs et des récompenses."
              : "Edit an existing mission with objectives and rewards."}
          </p>
        </div>
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  placeholder={
                                    language === "fr"
                                      ? "Entrez la description de la mission"
                              ...
                              <FormDescription>
                                {language === "fr"
                                  ? "Expliquez ce que la mission implique et comment la terminer"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger>
                                    <SelectValue
                                      placeholder={
                                        language === "fr" ? "Sélectionnez la difficulté" : "Select difficulty"
                                      }
                                    />
                                  </SelectTrigger>
                                </FormControl>
                              ...
                              <FormDescription>
                                {language === "fr"
                                  ? "À quel point la mission est difficile à terminer"
                            ...
                            <FormItem>
                              ...
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger>
                                    <SelectValue
                                      placeholder={language === "fr" ? "Sélectionnez la catégorie" : "Select category"}
                                    />
                                  </SelectTrigger>
                                </FormControl>
                                <SelectContent>
                                  ...
                                  <SelectItem value="achievement">
                                    {language === "fr" ? "Réalisation" : "Achievement"}
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                              <FormDescription>
                                {language === "fr"
                                  ? "Le type d'activité impliquée dans cette mission"
                ...
                <Form {...objectivesForm}>
                  <form onSubmit={objectivesForm.handleSubmit(onObjectivesSubmit)} className="space-y-4">
                    <motion.div variants={container} initial="hidden" animate={animateCards ? "show" : "hidden"}>
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input
                                      placeholder={
                                        language === "fr" ? "Entrez le nom de l'objectif" : "Enter objective name"
                                      }
                                      {...field}
                                    />
                                  </FormControl>
                                ...
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Textarea
                                      placeholder={
                                        language === "fr"
                                          ? "Entrez la description de l'objectif"
                                  ...
                                  <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                      <FormControl>
                                        <SelectTrigger>
                                          <SelectValue
                                            placeholder={language === "fr" ? "Sélectionnez le type" : "Select type"}
                                          />
                                        </SelectTrigger>
                                      </FormControl>
                                      <SelectContent>
                                        <SelectItem value="trade">
                                          {language === "fr" ? "Trade Complet" : "Complete Trade"}
                                        </SelectItem>
                                        <SelectItem value="volume">
                                          {language === "fr" ? "Volume de Trading" : "Trading Volume"}
                                        </SelectItem>
                                        <SelectItem value="profit">
                                          {language === "fr" ? "Réaliser un Profit" : "Achieve Profit"}
                                        </SelectItem>
                                        <SelectItem value="streak">
                                          {language === "fr" ? "Série de Trading" : "Trading Streak"}
                                        </SelectItem>
                                        <SelectItem value="social">
                                          {language === "fr" ? "Action Sociale" : "Social Action"}
                                        </SelectItem>
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormControl>
                                      <Input
                                        placeholder={
                                          language === "fr" ? "Entrez la valeur cible" : "Enter target value"
                                        }
                                        {...field}
                                      />
                                    </FormControl>
                      ...
                      <motion.div variants={item}>
                        <Button variant="outline" className="w-full gap-2 my-2" type="button">
                          <ChevronRight className="h-4 w-4" />
                    ...
                    <motion.div variants={container} initial="hidden" animate={animateCards ? "show" : "hidden"}>
                      <motion.div variants={item}>
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>{language === "fr" ? "Points XP" : "XP Points"}</FormLabel>
                              <FormControl>
                                <Input
                            ...
                            <FormItem>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <FormControl>
                                  <Input
                                    placeholder={
                                      language === "fr" ? "Entrez le montant du bonus" : "Enter bonus amount"
                                    }
                                    {...field}
                                  />
                                </FormControl>
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                              ...
                              <div className="space-y-1 leading-none">
                                <FormLabel>
                                  {language === "fr" ? "Débloquer une Fonctionnalité" : "Unlock Feature"}
                                </FormLabel>
                                <FormDescription>
                                  {language === "fr"
                      ...
                      {rewardsForm.watch("unlockFeature") && (
                        <motion.div variants={item}>
                          <FormField
                            control={rewardsForm.control}
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel>
                                  {language === "fr" ? "Fonctionnalité à Débloquer" : "Feature to Unlock"}
                                </FormLabel>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  <FormControl>
                                    <SelectTrigger>
                                      <SelectValue
                                        placeholder={
                                          language === "fr" ? "Sélectionnez la fonctionnalité" : "Select feature"
                                        }
                                      />
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent>
                                    <SelectItem value="premiumBot">
                                      {language === "fr" ? "Accès au Bot Premium" : "Premium Bot Access"}
                                    </SelectItem>
                                    <SelectItem value="advancedAnalytics">
                                      {language === "fr" ? "Analyses Avancées" : "Advanced Analytics"}
                                    </SelectItem>
                                    <SelectItem value="vipSupport">
                                      {language === "fr" ? "Support VIP" : "VIP Support"}
                                    </SelectItem>
                                    <SelectItem value="customStrategies">
                                      {language === "fr" ? "Stratégies Personnalisées" : "Custom Strategies"}
                                    </SelectItem>
                                  </SelectContent>
                                </Select>
                                <FormDescription>
                            ...
                            <FormItem>
                              ...
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger>
                                    <SelectValue
                                      placeholder={language === "fr" ? "Sélectionnez le statut" : "Select status"}
                                    />
                                  </SelectTrigger>
                                </FormControl>
                                <SelectContent>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                              ...
                              <div className="space-y-1 leading-none">
                                <FormLabel>
                                  {language === "fr" ? "Exiger des Prérequis" : "Require Prerequisites"}
                                </FormLabel>
                                <FormDescription>
                                  {language === "fr"
                                    ? "Exiger la complétion d'autres missions en premier"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 my-2">
                              ...
                              <div className="space-y-1 leading-none">
                                <FormLabel>
                                  {language === "fr" ? "Notifier les Utilisateurs" : "Notify Users"}
                                </FormLabel>
                                <FormDescription>
                                  {language === "fr"
