...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // In a real app, you would validate credentials and get the user role from the backend
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-background/80 p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center ">
          ...
          <p className="text-muted-foreground mt-2">Sign in to access your trading dashboard</p>
        </div>
